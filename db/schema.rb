...
ActiveRecord::Schema.define(version: 2018_12_09_091358) do
  ...
  create_table "club_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_club_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_club_users_on_reset_password_token", unique: true
  end
